...
def test_package_imports() -> None:
    ...
    assert pyfoldercheck.__name__ == "pyfoldercheck"


def test_all_modules_import() -> None:
    """Every module in the package imports without errors."""
    for info in pkgutil.walk_packages(pyfoldercheck.__path__, prefix="pyfoldercheck.", onerror=_raise_on_package_error):
